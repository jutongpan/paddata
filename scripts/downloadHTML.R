...
vt_link <- c(
  ...
  "https://pad.skyozora.com/news/（12/12實裝）部份合作角色追加進化形態＆能力調整！",
  "https://pad.skyozora.com/news/（12/26實裝）部份寵物追加進化形態＆能力調整！",
  "https://pad.skyozora.com/news/（12/26實裝）部份正月版寵物追加進化形態＆能力調整！"
)
